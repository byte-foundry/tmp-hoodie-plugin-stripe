...
module.exports = function(hoodie, doneCallback) {
	...
	router['subscriptions.list'] = function handleSubscriptionsList(originDb, task) {
		console.log('List my subscription');
